...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.eopeter.flutter_dtmf.DtmfPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_dtmf, com.eopeter.flutter_dtmf.DtmfPlugin", e);
    }
    try {
